...
var register_tm =  '<div class="login_box" id="register_box">'+
			      '<a class="be_photoer_register" href="iamphotog.htm"/*tpa=http://paiwo.co/iamphotog*/>立刻成为摄影师</a>'+
			      '<div class="login_contet">'+
			       ...
			       ' </ul>'+
			     ' <p class="my-font">我已阅读并同意 <a class="agreement" target="_blank" href="protocol.htm"/*tpa=http://paiwo.co/protocol*/>拍我网用户服务协议</a> </p>'+
...
var login_tm =  '<div class="register_box"  id="login_box">'+
				...
				'</div>'+
				'<a class="be_photoer" href="iamphotog.htm"/*tpa=http://paiwo.co/iamphotog*/>立刻成为摄影师</a>'
		    '</div>';
...
//常用的邮箱
var EMAIL_MAP = {
    'http://paiwo.co/static/js/login/qq.com': 'http://mail.qq.com/',
    'http://paiwo.co/static/js/login/gmail.com': 'http://mail.google.com/',
    'http://paiwo.co/static/js/login/sina.com': 'http://mail.sina.com.cn/',
    'http://paiwo.co/static/js/login/163.com': 'http://mail.163.com/',
    'http://paiwo.co/static/js/login/126.com': 'http://mail.126.com/',
    'http://paiwo.co/static/js/login/yeah.net': 'http://www.yeah.net/',
    'http://paiwo.co/static/js/login/sohu.com': 'http://mail.sohu.com/',
    'http://paiwo.co/static/js/login/tom.com': 'http://mail.tom.com/',
    'http://paiwo.co/static/js/login/sogou.com': 'http://mail.sogou.com/',
    'http://paiwo.co/static/js/login/139.com': 'http://mail.10086.cn/',
    'http://paiwo.co/static/js/login/hotmail.com': 'http://www.hotmail.com/',
    'http://paiwo.co/static/js/login/live.com': 'http://login.live.com/',
    'http://paiwo.co/static/js/login/live.cn': 'http://login.live.cn/',
    'http://paiwo.co/static/js/login/live.com.cn': 'http://login.live.com.cn/',
    'http://paiwo.co/static/js/login/189.com': 'http://webmail16.189.cn/webmail/',
    'http://paiwo.co/static/js/login/yahoo.com.cn': 'http://mail.cn.yahoo.com/',
    'http://paiwo.co/static/js/login/yahoo.cn': 'http://mail.cn.yahoo.com/',
    'http://paiwo.co/static/js/login/eyou.com': 'http://www.eyou.com/',
    'http://paiwo.co/static/js/login/21cn.com': 'http://mail.21cn.com/',
    'http://paiwo.co/static/js/login/188.com': 'http://www.188.com/',
    'http://paiwo.co/static/js/login/foxmail.coom': 'http://www.foxmail.com/'
}
//显示注册框
